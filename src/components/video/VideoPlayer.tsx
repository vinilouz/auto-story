...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({ props, compositionId = "CaptionedVideo" }) => {
  return (
    <div className="w-full aspect-video rounded-lg overflow-hidden border bg-black shadow-lg">
      <Player
        component={compositionId === 'CaptionedVideoFull' ? RemotionVideoFull as any : RemotionVideo as any}
