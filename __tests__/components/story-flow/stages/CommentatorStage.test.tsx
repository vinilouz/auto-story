...
describe("CommentatorStage", () => {
  describe("form fields", () => {
    ...
    it("shows personality value in textarea", () => {
      const state = createMockState({
        commPersonality: "Funny and witty",
        setCommPersonality: jest.fn(),
      });
      render(<CommentatorStage state={state} actions={createMockActions()} />);
  ...
  describe("form interactions", () => {
    ...
    it("calls setCommPersonality on personality change", () => {
      ...
      const state = createMockState({
        setCommPersonality: setCommPersonalityMock,
      });
      render(<CommentatorStage state={state} actions={createMockActions()} />);
      fireEvent.change(screen.getByPlaceholderText(/personality/i), {
    ...
    it("calls setCommImagePrompt on imagePrompt change", () => {
      ...
      const state = createMockState({
        setCommImagePrompt: setCommImagePromptMock,
      });
      render(<CommentatorStage state={state} actions={createMockActions()} />);
      fireEvent.change(screen.getByPlaceholderText(/appearance/i), {
        target: { value: "Short hair" },
      });
  ...
  describe("generate button", () => {
    ...
    it("calls generateCommentatorImage when clicked", () => {
      ...
      const actions = {
        ...createMockActions(),
        generateCommentatorImage: generateMock,
      };
