...
type PartialState = Partial<StoryFlowState> & Pick<StoryFlowState, "segments" | "loading">;
...
describe("DescriptionsStage", () => {
  ...
  describe("generate missing button", () => {
    ...
    it("calls generateMissingDescriptions when clicked", () => {
      ...
      const state = createMockState({ segments, loading: false });
      const actions = { ...createMockActions(), generateMissingDescriptions: generateMissingMock };
  ...
  describe("edit functionality", () => {
    ...
    it("shows textarea when editing", () => {
      ...
      const editButton = screen.getAllByRole("button").find(b => b.querySelector("svg"));
      if (editButton) {
    ...
    it("calls updateSegmentImagePrompt on save", () => {
      ...
      const segments: Segment[] = [
        { text: "Scene", imagePrompt: "Original" },
      ];
      const state = createMockState({ segments });
      const actions = { ...createMockActions(), updateSegmentImagePrompt: updateMock };
